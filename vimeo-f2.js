...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateDisplayForAutoplayStatus() {
        ...
        if (autoplayStatus.every((status) => status === true)) {
            ...
            document
                .querySelectorAll(".cdk-anim-comp .vimeo-embed")
                .forEach((elem) => (elem.style.display = "block"));
            document
                .querySelectorAll(".cdk-anim-comp .cdk-anim-img-wrapper")
                .forEach((elem) => (elem.style.display = "none"));
        } else if (autoplayStatus.some((status) => status === false)) {
